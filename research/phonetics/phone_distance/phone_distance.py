...
espeak-ng target. Standalone research module; app integration is a follow-up.
"""
...
# Import the sibling fold-map loader (research/phonetics/fold_map/fold_map.py).
_FOLD_DIR = Path(__file__).resolve().parent.parent / "fold_map"
sys.path.insert(0, str(_FOLD_DIR))
